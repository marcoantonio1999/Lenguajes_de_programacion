...
parserExprToExpr (Parser.RecurFn f x e) = Sintax.(App fix f x  parserExprToExpr e)
...
fix = (Sintax.App (Sintax.Fn "f" (Sintax.Fn "x" (Sintax.App (V "f") (Sintax.App (V "x") (V "x"))))) (Sintax.Fn "x" (Sintax.App (V "f") (Sintax.App (V "x") (V "x")))))
