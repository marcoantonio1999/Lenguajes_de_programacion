...
;Fernando Daniel Castillo Barron
...
; funcion que nos quita elemento a de una lista
;; quitaElemento: a -> (listof a)-> (listof a)
...
(define (punto-medio p q)
  (if(equal? (and (Punto? p) (Punto? q)) #f) "error solo es valido la estructura punto"
